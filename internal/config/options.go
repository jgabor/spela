...
var options = []Option{
	...
	stringOption("steam_path", "steamPath", nav.SettingsPaths, "Steam path", "Use this Steam installation when Spela next starts. Requires restart.", KindPath, VisibilityTUI|VisibilityGUI|VisibilityWails, func(c *Config) string { return c.SteamPath }, func(c *Config, value string) { c.SteamPath = value }),
